...
- `.cidd/state.md`가 없으면 "아직 CIDD 상태 없음 — plan부터 시작"이라고 알린다.

## 보여주는 것 (state.md에서)
- **active slug** + **stage**(plan/build/review/done) + **status**(active/paused/abandoned).
...
- 산출물 경로: `.cidd/{plans,builds,reviews}/<slug>.md` 중 존재하는 것.
